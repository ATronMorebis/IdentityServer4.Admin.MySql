...
namespace Trov.IdentityServer4.Admin.UnitTests.Controllers
{
    public class ConfigurationControllerTests
    {
        ...
        private async Task<Client> GenerateClient(ConfigurationDbContext dbContext)
        {
        ...
        private IServiceProvider GetServices()
        {
            ...
            services.AddOptions();
            services.AddDbContext<ConfigurationDbContext>(b => b.UseInMemoryDatabase(Guid.NewGuid().ToString()).UseInternalServiceProvider(efServiceProvider));
