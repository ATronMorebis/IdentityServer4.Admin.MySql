...
namespace Trov.IdentityServer4.Admin.Configuration

{
    public class Clients
    {
        private const string RentersBaseUrl = "http://localhost:7000"; //todo: will be changed
        ...
        public static IEnumerable<Client> GetClients()
        {
            ...
            return new List<Client>
            {
	            ...
	            ///////////////////////////////////////////
	            // Trov.IdentityServer4.Admin Client
	            //////////////////////////////////////////
	            new Client
                {
                ...
                new Client
                {
                    ...
                    ClientId = "TBD",
                    ClientName = "TBD",
                    ClientUri = RentersBaseUrl,

                    AllowedGrantTypes = GrantTypes.ImplicitAndClientCredentials,
                    AllowAccessTokensViaBrowser = true,

                    RedirectUris = { $"{RentersBaseUrl}/signin-oidc"},
                    FrontChannelLogoutUri = $"{RentersBaseUrl}/signout-oidc",
                    PostLogoutRedirectUris = { $"{RentersBaseUrl}/signout-callback-oidc"},
                    AllowedCorsOrigins = { RentersBaseUrl },
