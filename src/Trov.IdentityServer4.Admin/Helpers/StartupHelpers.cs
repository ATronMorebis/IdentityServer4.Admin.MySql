...
using Trov.IdentityServer4.Admin.Constants;
using Trov.IdentityServer4.Admin.ExceptionHandling;
using Trov.IdentityServer4.Admin.Middlewares;
using Trov.IdentityServer4.EntityFramework.DbContexts;
using Trov.IdentityServer4.EntityFramework.Entities.Identity;

namespace Trov.IdentityServer4.Admin.Helpers
{
    public static class StartupHelpers
    {
        ...
        public static void RegisterDbContextsStaging(this IServiceCollection services)
        {
            ...
            services.AddDbContext<ConfigurationDbContext>(optionsBuilder => optionsBuilder.UseInMemoryDatabase(Guid.NewGuid().ToString()));
        }
        ...
        //        .WriteTo.MSSqlServer(configuration.GetConnectionString(ConfigurationConsts.AdminConnectionStringKeyConfiguration),
        //            TableConsts.Logging,
